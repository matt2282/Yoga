...
const Seated = () => {
  ...
  const Background = "linear-gradient(180deg, #008989 0%, #890000 100%)";
  return (
    <body className="flex flex-col items-center bg-seated bg-no-repeat bg-cover min-h-screen 2xsm:max-h-[800px] xsm:max-h-[700px] sm:max-h-[1000px] md:max-h-[1200px] lg:max-h-fit">
      <PoseHeader title="Seated Poses" />
      <div className="flex  gap-2 2xsm:scale-[35%] xsm:scale-[45%] sm:scale-[60%] md:scale-75 lg:scale-100 2xsm:translate-y-[-575px] xsm:translate-y-[-300px] sm:translate-y-[-210px] md:translate-y-[-12px] lg:translate-y-0"  >
