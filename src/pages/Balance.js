...
const Balance = () => {
  ...
  const poses = [26,34,41,16,13,21,17,22];
  ...
  const Background = "linear-gradient(180deg, rgb(6, 28, 68) 0%, #602F0F 100%)";
  const goldBackground= "#E7C12C"
  return (
    <body className="flex flex-col items-center bg-seated bg-no-repeat bg-cover min-h-screen 2xsm:max-h-[800px] xsm:max-h-[700px] sm:max-h-[1000px] md:max-h-[1200px] lg:max-h-fit">
      ...
      <PoseHeader title="Balance Poses" />
